...
function printQuote () {
  var message = getRandomQuote();  // message stores random quote from getRandomQuote() function
  var HTML = '';  //create an html variable with an empty string 
...
//builds a template string with quote, source, citation, and year
  HTML = '<p class="quote">'; 
  ...
  if (message.year) {
    HTML += '<span class="year">' + message.year + '</span>'; //when citation property exist in quote object add it to the template string
  }
